...
func main() {
	...
	http.Handle("/bookings", uh.Authenticated(http.HandlerFunc(mh.Bookings)))
	...
	http.Handle("/theater/schedule/book/", uh.Authenticated(http.HandlerFunc(mh.TheaterScheduleBook)))
